...
from qgis.core import QgsGeometry,QgsWkbTypes,QgsPointXY,QgsCircle,QgsPoint,QgsRectangle
...
class run(object):
    ...
    def setGeometryToToolbar(self, geo, isValid):#from the maptool
        isCircle=False
        isRectangle=True
        self.toolbar.setGeometry(geo, isValid, isCircle,isRectangle)#=> toolbar
